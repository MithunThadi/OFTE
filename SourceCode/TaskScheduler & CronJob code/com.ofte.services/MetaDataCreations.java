...
//						sftpTimedMonitor.timerAccess(metaDataMap.get("schedulerName"), metaDataMap.get("pollInterval"),
//								metaDataMap.get("pollUnits"));
						System.out.println("creating task for scheduler");
						TaskUtils taskCreate = new TaskUtils();
						String pollTime = taskCreate.calculatePoll(metaDataMap.get("pollUnits"), metaDataMap.get("pollInterval"));
...
//						TimedMonitor timedMonitor = new TimedMonitor();
						...
						// pollunits
//						timedMonitor.timerAccess(metaDataMap.get("monitorName"), metaDataMap.get("pollInterval"),
//								metaDataMap.get("pollUnits"));
						if(System.getProperty("os.name").contains("Windows")) {
							...
							int jobStatus = jobUtils.createJob(metaDataMap.get("monitorName"), metaDataMap.get("pollInterval"), metaDataMap.get("pollUnits"), "monitor");
							if (jobStatus==0) {
								System.out.println("Job create Succefully in if");
								System.exit(0);
							}else {
