 ...
 * 
 * Class Functionality:
 *                    The main functionality of this class is creation of kafka topics by using zookeeper hosts
 * 
 * Methods:
...
public class KafkaSecondLayerConnectService {
	...
	//Creating Logger object for KafkaSecondLayerConnectService class
	 Logger logger = Logger.getLogger(KafkaSecondLayerConnectService.class.getName());
