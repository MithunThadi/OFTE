...
public class KafkaServerService {
	...
	public ZkClient setupEmbeddedZooKeeper()
		...
		System.out.println(
				"ZookeeperPort:" + zkPort + "      in kafkaserver sevice");
	...
	public Properties getBrokerConfig() throws IOException {
		...
		properties.put("listeners", "0.0.0.0:"+KafkaServerService.getBROKER_PORT());
	...
	public ProducerConfig getProducerConfig() {
		...
		properties.put("" + ".backoff.ms", (String) loadProperties
...
//				.getKafkaProperties().getProperty("PRODUCER.TYPE"));
	...
	public void shutdown() {
		...
		try {
			...
			FileUtils.forceDelete(new File("D:\\Dynamic logs\\kafka-" + BROKER_PORT + "-logs-zk-"
					+ zkPort));
