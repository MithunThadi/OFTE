 ...
 * 
 * Class Functionality:
 * 						This class has methods to connect and interact with Cassandra DB according to OFTE requirements
 * Methods:
 * 			public String transferStatusCheck(Session session, Map<String, String> transferMetaData2)
 *			public String getSourceFilePath(Session session, Map<String, String> transferMetaData2)
 ...
 *			public void updateTransferDetails(Session session, Map<String, String> transferMetaData1, Map<String, String> metadata)
 ...
 *			public String DBMonitorCheck(Session session, String Monitor_name)throws NoSuchFieldException, SecurityException
 *			public String kafkaSecondCheckMonitor(Session session, String Monitor_name)throws NoSuchFieldException, SecurityException
 *			public String kafkaSecondCheckTransfer(Session session, String transfer_id)throws NoSuchFieldException, SecurityException
...
public class CassandraInteracter {
	...
	/**
	 * This method updates the thread status and monitor status values in the monitor table based on monitor name
	 * @param session
	 * @param Monitor_name
	 */
	public void started(Session session,String Monitor_name) {
	...
	/**
	 * This method updates the monitor status value in the monitor table based on monitor name
	 * @param session
	 * @param Monitor_name
	 */
	public void deleting(Session session, String Monitor_name) {
	...
	public String kafkaSecondCheckMonitor(Session session, String Monitor_name)
			throws NoSuchFieldException, SecurityException {
		//Declaration of parameter monitorAllDetails and initialising it to null
	...
	/**
	 * This method retrieves the all the details from the monitor transfer table based on transfer id
	 * @param session
	 * @param transfer_id
	...
	public String kafkaSecondCheckTransfer(Session session, String transfer_id)
			throws NoSuchFieldException, SecurityException {
		//Declaration of parameter monitorTransferAllDetails and initialising it to null
		...
		for (Row row : result) {
			...
			monitorTransferAllDetails=row.getString("transfer_id")+","+row.getString("monitor_name")+","+
	 ...
	 */
	public Session connectCassandra() {
		//Declaration of parameter serverIp and initialising it by using loadProperties file
		String serverIp = loadProperties.getCassandraProperties().getProperty("SERVERIP");
		//Declaration of parameter keyspace and initialising it by using loadProperties file
		String keyspace = loadProperties.getCassandraProperties().getProperty("KEYSPACE");
