...
/**
 * Servlet implementation class OneTimeTransfer
 */
@WebServlet("/OneTimeTransfer")
public class OneTimeTransfer extends HttpServlet {
//	private static final long serialVersionUID = 1L;
	HashMap<String, String> hashMap = new HashMap<String, String>();
//	com.ofte.services.MetaDataCreations metaDataCreations = new MetaDataCreations();
...
//        String str[] = {"-mn "+monitorName,"-jn "+jobName,"-sd "+sourceDirectory,"-tr "+sourceTriggerPattern,"-sfp "+sourceFilePattern,"-dd "+destinationDirectory,destinationFilePattern,"-trd "+destinationTriggerPattern,"-pu "+pollUnits,"-pi "+pollInterval,"-gt "+XMLFilePath};
...
//        String string = "-mn "+monitorName+",-jn "+jobName+",-pi "+pollInterval+",-pu "+pollUnits+",-dd "+destinationDirectory+" "+ sourceDirectory+",-tr "+sourceTriggerPattern+",-trd "+destinationTriggerPattern+",-gt "+XMLFilePath+",-sfp "+sourceFilePattern;
...
//        example.result("-mn "+monitorName+" -jn "+jobName+" -pi "+pollInterval+" -pu "+pollUnits+" -dd "+destinationDirectory+" "+ sourceDirectory+" -tr "+sourceTriggerPattern+" -trd "+destinationTriggerPattern+" -gt "+XMLFilePath+" -sfp "+sourceFilePattern);
...
//        writer.println(htmlRespone);
	     ...
	     out.println("window.open('http://localhost:8080/TestingUI/Open_OFTE_OneTimeTransfer_Pages.html','_self')");
	     out.println("</script>");
