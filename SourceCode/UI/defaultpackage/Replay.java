...
import com.ofte.services.ProcessFiles;
...
public class Replay extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		out.println("alert('Do u want to replay');");
		out.println(
				"window.open('http://localhost:8080/Testing_UI/Open_OFTE_Monitor_TransferTable_StatusPages.jsp','_self')");
		out.println("</script>");
	}
}
