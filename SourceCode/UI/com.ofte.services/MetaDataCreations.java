...
public class MetaDataCreations {
	...
	//Creating an object for StringWriter class
	 ...
	 /**
	   ...
	   * @return metaDataMap
	   */
	public HashMap<String, String> mapUpdater(int i, HashMap<String, String> map, HashMap<String, String> metaDataMap)			
	{	
		try {
			//switch case
...
//				metaDataMap.put("sourceDirectory", metaData.getValue().toString());
//				break;
//			case "-dd":
//				metaDataMap.put("destinationDirectory", metaData.getValue().toString());
...
////				break;
//			case "-tr":
//				metaDataMap.put("triggerPattern", metaData.getValue().toString());
//				break;
//			case "-trd":
//				metaDataMap.put("triggerDestination", metaData.getValue().toString());
//				break;
//			case "-pi":
//				metaDataMap.put("pollInterval", metaData.getValue().toString());
//				break;
//			case "-pu":
...
//				break;
//			case "-gt":
//				metaDataMap.put("xmlFilePath", metaData.getValue().toString());
//				break;
//			case "-sfp":
//				metaDataMap.put("sourcefilePattern", metaData.getValue().toString());
//				break;
//			case "-rs" :
//				metaDataMap.put("sftpAsSource", metaData.getValue().toString());
//			case "-rd" :
//				metaDataMap.put("sftpAsDestination", metaData.getValue().toString());
//
//			case "-sn" :
//				metaDataMap.put("schedulerName", metaData.getValue().toString());
//			case "-de":
//				if ("overwrite".equalsIgnoreCase(metaData.getValue().toString()) || "error".equalsIgnoreCase(metaData.getValue().toString())) {
//					metaDataMap.put("destinationExists", metaData.getValue().toString());
//				} else {
...
//				break;
//			case "-sfd":
//				if ("delete".equalsIgnoreCase(metaData.getValue().toString()) || "leave".equalsIgnoreCase(metaData.getValue().toString())) {
...
//			}
	 ...
	 * @throws Exception
	 */
	public void fetchingUIDetails(HashMap<String, String> hashMap) throws Exception {
		try {
...
//				if(cassandraInteracter.DBMonitorCheck(cassandraInteracter.connectCassandra(), metaDataMap.get("monitorName")) == null || metaDataMap.get("monitorOverride").equalsIgnoreCase("true")) {
//					cassandraInteracter.starting(cassandraInteracter.connectCassandra(), metaDataMap.get("monitorName"));
//				}
