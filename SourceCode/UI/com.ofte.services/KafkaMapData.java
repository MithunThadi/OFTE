 ...
 * 
 * ClassFunctionality:
 * 						This class is used to publish and consume the metadata mapdata
 *Methods:
...
public class KafkaMapData {
	...
	ZkClient zkClient = new ZkClient(loadProperties.getSecondLayerProperties().getProperty("ZOOKEEPERHOSTS"), Integer.parseInt(loadProperties.getSecondLayerProperties().getProperty("SESSIONTIMEOUT")), Integer.parseInt(loadProperties.getSecondLayerProperties().getProperty("CONNECTIONTIMEOUT")),
	...
	public void publish(String TOPIC, String Key, String Message) {
		...
		ZkUtils zkutils = new ZkUtils(zkClient,
				new ZkConnection(loadProperties.getSecondLayerProperties().getProperty("ZOOKEEPERHOSTS")), true);
		...
		if (!AdminUtils.topicExists(zkutils, TOPIC)) {
			...
			//Creation of topic
			kafkaSecondeLayerConnect.createTopic(TOPIC,Integer.parseInt(loadProperties.getSecondLayerProperties().getProperty("NUMBEROFPARTITIONS")), Integer.parseInt(loadProperties.getSecondLayerProperties().getProperty("NUMBEROFREPLICATIONS")));
		}
	...
	public String consume(String TOPIC) {
		...
		properties.put("key.deserializer",
				loadProperties.getSecondLayerProperties().getProperty("KEY.DESERIALIZER"));
		properties.put("value.deserializer",
				loadProperties.getSecondLayerProperties().getProperty("VALUE.DESERIALIZER"));
