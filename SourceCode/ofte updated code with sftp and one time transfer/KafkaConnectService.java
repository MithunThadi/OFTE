 ...
 * the number of partitions creation the kafka topics dynamically by using
 * zookeeper
 * 
...
public class KafkaConnectService {
	...
	/**
	 * This method creates a topic similar to the file transferred based on the
	 * number of partitions and number of replications
	 * 
	 * @param topicName
	...
	public void createTopic(String topicName, int numberOfPartitions,
		...
		try {
			...
			zkClient = new ZkClient(
					loadProperties.getKafkaProperties()
							.getProperty("ZOOKEEPERHOSTS"),
					Integer.parseInt(loadProperties.getKafkaProperties()
			...
			// loadProperties file
			zkUtils = new ZkUtils(zkClient, new ZkConnection(loadProperties
					.getKafkaProperties().getProperty("ZOOKEEPERHOSTS")),
					false);
