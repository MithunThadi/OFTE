...
public class KafkaSecondeLayerConnect {

	 Logger logger = Logger.getLogger(KafkaSecondeLayerConnect.class.getName());
	...
	public void createTopic(String topicName, int numberOfPartitions, int numberOfReplications) {
		...
		try {
			String zookeeperHosts = "localhost:2182"; // If multiple zookeeper then -> String zookeeperHosts =
